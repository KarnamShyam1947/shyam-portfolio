  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 p-3 rounded-full bg-white dark:bg-slate-700 shadow-lg hover:shadow-xl transition-all"
      ...
      <div className={`fixed right-0 top-0 h-full w-72 bg-white dark:bg-slate-800 shadow-2xl transform transition-transform duration-300 z-50 ${isThemeControlOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="p-6">
